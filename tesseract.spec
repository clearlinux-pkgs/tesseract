...
Source0  : https://github.com/tesseract-ocr/tesseract/archive/4.1.0/tesseract-4.1.0.tar.gz
...
%prep
%setup -q -n tesseract-4.1.0
cd %{_builddir}/tesseract-4.1.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573753558
...
cp %{_builddir}/tesseract-4.1.0/LICENSE %{buildroot}/usr/share/package-licenses/tesseract/2b8b815229aa8a61e483fb4ba0588b8b6c491890
%make_install
