...
Version  : 5.3.0
Release  : 8
URL      : https://github.com/tesseract-ocr/tesseract/archive/5.3.0/tesseract-5.3.0.tar.gz
Source0  : https://github.com/tesseract-ocr/tesseract/archive/5.3.0/tesseract-5.3.0.tar.gz
...
%prep
%setup -q -n tesseract-5.3.0
cd %{_builddir}/tesseract-5.3.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672202646
