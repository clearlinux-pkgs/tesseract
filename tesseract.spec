...
Source0  : https://github.com/tesseract-ocr/tesseract/archive/4.0.0.tar.gz
Summary  : An OCR program
...
export LANG=C
export SOURCE_DATE_EPOCH=1561221811
...
cp COPYING %{buildroot}/usr/share/package-licenses/tesseract/COPYING
cp LICENSE %{buildroot}/usr/share/package-licenses/tesseract/LICENSE
%make_install
...
/usr/lib64/libtesseract.so.4.0.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/tesseract/COPYING
/usr/share/package-licenses/tesseract/LICENSE
